    ...
    <tr>
        ...
        <td>
            ...
            <ol>
                ...
                <li><u>Don't kill or knock out anyone in the train track arean</u>: After killing the others, you can shoot McBane from the clifftop directly, then run to the finish and wait for the alert to end. It may not be possible to do this and badge #1 in the same playthrough, however.</li>
                <li><u>Complete the mission on Hard difficulty</u>: Self-explnatory.</li>
            </ol>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <ol>
                ...
                <li><u>Don't use the Gatling Gun</u>: Self-explanatory. You may as well use the disguise for this, since this and badge #5 cannot be completed simultaneously.</li>
